## R ShinyTutorial - 12. Creating KPIs or Info Boxes in shiny dashboards | - R Programming Tutorials

# use infoBox() for static output
# for dynamic - use help of server by using infoBoxOutput()
