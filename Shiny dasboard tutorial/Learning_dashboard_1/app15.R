## R ShinyTutorial - 15. Changing page title and skin color

# how to change aesthetics in of the overall dashboard eg- dashboard header color, ip address to be shown by deault on the chrome tab heading,
# all these can be changes by page parameters.
