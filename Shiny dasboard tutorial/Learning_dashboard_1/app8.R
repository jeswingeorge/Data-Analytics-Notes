## R ShinyTutorial - 8. How to highlight new menu using badge - R Programming Tutorials
# How to highlight some of the information you put in the menu to the users

# Eg - to highlight something new: as in Mxplayer new videos are highlighted using 'NEW' symbol

# Done by adding badgeLabel and badgeColor to the 
