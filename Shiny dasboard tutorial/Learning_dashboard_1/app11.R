## R ShinyTutorial - 11. Shiny Dashboards - Adding Tabs in a Box | - R Programming Tutorials

# As the dashboard made in tutorial 10 is full and no space to add more charts/displays.
# For that we can use tabs - 
# step 1. Use tabBox() function and put the 2 box() functions inside it.
# step 2. Replace box() name by tabPanel() function name 
